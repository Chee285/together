...
<header>
    <div class="header">
        <div class="logo_login">
            ...
            %>
            <ul class="login_menu">
                <li><a href="./memberpage/login.jsp">로그인</a></li>
                <li><a href="./memberpage/signup.html">회원가입</a></li>
            </ul>
            <%
            }else{ //로그인
            %>
            <div class="logout_menu">
              <div class="coin_box" style="display:inline;">
                    <img src="./common_images/coin.png"  width="15px" alt="코인">
                    <span>보유코인</span>
                    <span class="mem_balance" id="mem_balance" > <%=m.getMem_balance()%>원&nbsp;</span>&nbsp;&nbsp;
                </div> <!-- coin_box -->
                
                <span><a href="./memberpage/charge.jsp" style="display:inline;"><input class="btn btn-primary" type="button" value="충전하기"></a></span>&nbsp;&nbsp;&nbsp;

                <div style="display:inline;">반가워요&nbsp; <span class="mem_name" id="mem_id"><%=m.getMem_nickname()%>님!</span></div>
            	<a href ="./logout"id="logout" style="dispaly:inline;" class="btn btn-primary">로그아웃</a>
            </div> <!-- logout_menu -->
            <%
            }
            %>
    ...
    <nav class="pc_nav">      
        <ul>
            ...
            <!-- TOGETHER -->
            <li class="nav_item">
                <a class="nav_link cat" href="./category?cat_no=1">TOGETHER</a>
            </li>
            <!-- 인증모아보기 -->
            <li class="nav_item">
                <a class="nav_link pho_view" href="./togetherpage/all_photoshoot.jsp">인증모아보기</a>
            </li>
            ...
            %>
             <!-- 개설 -->
            <li class="nav_item">
                <a class="nav_link tog_setup" href="./togetherpage/infoadd.jsp?info=">개설</a>
            </li>
            <!-- 마이페이지 -->
            <li class="nav_item">
                <a class="nav_link mypage" href="./memberpage/mypage.html">마이페이지</a>
            </li>
            <%
            } 
            %>
        ...
        <div class="nav_bar">
            <ul>
                ...
                %>
                 <!-- 개설 -->
                <li class="nav_item">
                    <a class="nav_link tog_setup" href="./togetherpage/infoadd.jsp">개설</a>
                </li>
                <!-- 마이페이지 -->
                <li class="nav_item">
                    <a class="nav_link mypage" href="./memberpage/mypage.html">마이페이지</a>
