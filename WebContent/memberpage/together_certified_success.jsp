        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="card mb-5" style="height:100%; border:0px;">
                        ...
                        <div id='View_area'
                            ...
                            <img id ="prev_View_area" class="obj" src="image/img_ex.png">
                        </div>
                ...
                <div class="col-md-7">
                    ...
                    <button type="button" class="btn btn-primary" onclick ="location.href='http://localhost:8889/together/main'" >인증성공하였습니다</button>
